...
fun categorizeNumbers(intList: List<Int>): Map<String, List<Int>> {
    val result = intList
        .distinct()
        .sortedDescending()
...
fun getElements(intList: List<Int?>, numbers: Int): Int? {
    intList.forEach {
        if (it != null) {
            if (it > numbers)
                return it
